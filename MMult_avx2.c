...
void AddDot4x4(int k, double* a, int lda, double* b, int ldb, double* c, int ldc) {
  ...
  // C
  __m256d c00_10_20_30 = _mm256_setzero_pd(),
          c01_11_21_31 = _mm256_setzero_pd(),
          c02_12_22_32 = _mm256_setzero_pd(),
          c03_13_23_33 = _mm256_setzero_pd();
  // B
  __m256d bp0, bp1, bp2, bp3;
  // A
  __m256d a0p_1p_2p_3p;
  for (int p = 0; p < k; p++) {
    // a_0p = A(0, p);
    // a_1p = A(1, p);
    // a_2p = A(2, p);
    // a_3p = A(3, p);
    a0p_1p_2p_3p = _mm256_load_pd(a);
    a += 4;
    
    bp0 = _mm256_set1_pd(*b);
    bp1 = _mm256_set1_pd(*(b + 1));
    bp2 = _mm256_set1_pd(*(b + 2));
    bp3 = _mm256_set1_pd(*(b + 3));
    b += 4;
    // // 共享了对A的访问，重复利用A
    c00_10_20_30 += a0p_1p_2p_3p * bp0;
    c01_11_21_31 += a0p_1p_2p_3p * bp1;
    c02_12_22_32 += a0p_1p_2p_3p * bp2;
    c03_13_23_33 += a0p_1p_2p_3p * bp3;
  }
  ...
  // 并且由于store指令要求16字节对齐，所以声明临时数组时要对齐
    ...
    _mm256_store_pd(C_incr + 0, c00_10_20_30);
    _mm256_store_pd(C_incr + 4, c01_11_21_31);
    _mm256_store_pd(C_incr + 8, c02_12_22_32);
    _mm256_store_pd(C_incr + 12,c03_13_23_33);
